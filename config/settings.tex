...
%
% Judul laporan.
\def\judul{evaluasi persepsi publik terhadap aspek pelayanan rumah sakit berdasarkan standar nasional akreditasi rumah sakit (snars) melalui aspect-based analisis sentimen di media sosial}
%
