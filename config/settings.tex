...
%
% Judul laporan.
\def\judul{evaluasi persepsi publik terhadap aspek pelayanan rumah sakit berdasarkan standar nasional akreditasi rumah sakit (snars) melalui aspect-based sentimen analisis di media sosial}
%
% Tulis kembali judul laporan namun dengan bahasa Ingris
\def\judulInggris{Evaluation of Public Perception of Hospital Service Aspects Based on SNARS through Aspect-Based Sentiment Analysis on Social Media}
...
\def\penulisSatu{Arditio Reihansyah Putra Pradana} % nama lengkap penulis pertama
\def\penulisDua{Muhammad Rifat Fadhillah} % nama lengkap penulis kedua
\def\penulisTiga{Gabriel Edgar Firdausyah Nugroho} % nama lengkap penulis ketiga
%
% Tulis NPM Anda
% Kosongkan npmDua dan npmTiga jika Anda melaksanakan tugas akhir/laporan secara individu
\def\npmSatu{2106751972} % NPM penulis pertama
\def\npmDua{2106752470} % NPM penulis kedua
\def\npmTiga{2106752312} % NPM penulis ketiga
%
...
\def\programTiga{Ilmu Komputer} % program studi penulis ketiga
%
...
\def\studyProgramTiga{Computer Science} % 3rd author's study program
...
\def\pembimbingSatu{Satrio Yudhoatmojo, Ph.D.}
...
\def\pembimbingDua{Prof. Dr. Indra Budi, S.Kom., M.Kom.}
